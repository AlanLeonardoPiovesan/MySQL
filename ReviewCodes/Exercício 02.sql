...
/* TRAGA OS FUNCIONARIOS QUE TRABALHEM NO: 
-DEPARTAMENTO DE FILMES ou
-DEPARTAMENTO DE ROUPAS*/
 
SELECT COUNT(*) AS 'QUANTIDADE DE FUNCIONARIOS', DEPARTAMENTO
FROM FUNCIONARIOS
...
SELECT ID_FUNCIONARIO, NOME, DEPARTAMENTO
FROM FUNCIONARIOS
WHERE DEPARTAMENTO = 'Filmes'
OR DEPARTAMENTO = 'ROUPAS'
ORDER BY DEPARTAMENTO, ID_FUNCIONARIO;

/* GERAR A LISTA DAS FUNCIONARIAS (SEXO FEMININO) QUE TRABALHAM NO:
-DEPARTAMENTO DE FILMES ou
-DEPARTAMENTO LAR
JUNTO COM OS DADOS DE EMAIL*/
...
/* AQUI TERMINAM AS PROJEÇÕES E SELEÇÕES
*/
